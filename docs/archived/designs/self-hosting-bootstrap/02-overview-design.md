...
- Scaffold `docs/archived/designs/self-hosting-bootstrap/` using the existing harness templates and use it as the first active package.
...
3. The CLI discovers `docs/archived/designs/self-hosting-bootstrap/` as the active package.
