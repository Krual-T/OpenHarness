...
- `docs/archived/task-packages/runtime-verification-baseline/05-verification.md`
- `docs/archived/task-packages/runtime-verification-baseline/06-evidence.md`
...
- `docs/archived/task-packages/self-hosting-bootstrap/05-verification.md`
- `docs/archived/task-packages/self-hosting-bootstrap/06-evidence.md`
...
- `docs/archived/task-packages/workflow-redesign/05-verification.md`
...
- Decide in a later focused package whether to record verification runs under `.harness/artifacts/` and tie `05-verification.md` to those artifacts.
