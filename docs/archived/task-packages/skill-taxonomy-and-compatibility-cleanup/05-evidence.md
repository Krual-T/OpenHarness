...
- `docs/archived/task-packages/skill-taxonomy-and-compatibility-cleanup/04-verification.md`
- `docs/archived/task-packages/skill-taxonomy-and-compatibility-cleanup/05-evidence.md`
