...
- docs/archived/task-packages/skill-openai-metadata-adoption/05-verification.md
- docs/archived/task-packages/skill-openai-metadata-adoption/06-evidence.md
...
- sed -n '1,260p' docs/task-packages/skill-openai-metadata-adoption/05-verification.md
- sed -n '1,260p' docs/task-packages/skill-openai-metadata-adoption/06-evidence.md
