...
def build_parser() -> argparse.ArgumentParser:
    ...
    writing_guide_list_parser = writing_guide_subparsers.add_parser(
        ...
        description="List available writing guides.", formatter_class=argparse.RawDescriptionHelpFormatter,
    )
    ...
    writing_guide_read_parser = writing_guide_subparsers.add_parser(
        ...
        description="Read a writing guide by name.", formatter_class=argparse.RawDescriptionHelpFormatter,
    )
