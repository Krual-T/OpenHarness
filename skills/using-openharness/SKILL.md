...
- `.codex/skills/openharness/scripts/`
- `.codex/skills/openharness/tests/`
...
2. Read `.codex/skills/openharness/references/manifest.yaml` to discover the required design-package structure.
3. Run `uv run python .codex/skills/openharness/scripts/openharness.py bootstrap` to list active design packages.
...
## Skill Routing
Use child skills under `openharness` like this:
...
## Verification
- Run `uv run python .codex/skills/openharness/scripts/openharness.py check-designs` before claiming completion.
- Run `uv run python .codex/skills/openharness/scripts/openharness.py new-design <design_name> <design_id> <title>` to scaffold a new design package.
- Run `uv run python .codex/skills/openharness/scripts/openharness.py verify <design-name-or-id>` when a package declares required commands.
