...
**Handoff 原则**：这份文档是需求阶段的唯一交付物。任何人（或 AI）拿到它，不依赖聊天记录、不追问当事人，就应能理解：当前矛盾是什么、为什么现在做、做完后什么事实成立、边界在哪。如果写完后需要补充口头解释才能让别人看懂，说明文档还没写完。
...
8. 把这份 `requirements.md` 交给一个不了解本轮对话的人，他能否仅凭文档就理解当前矛盾、目标、边界和验收标准？
